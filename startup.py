...
keysight.write(
    f"VOLTage:LEVel {keysight_vset_ch1},(@1);:CURRent:LEVel {keysight_iset_ch1},(@1)"
)
keysight.write(
    f"VOLTage:LEVel {keysight_vset_ch3},(@3);:CURRent:LEVel {keysight_iset_ch3},(@3)"
)
keysight.write(
    f"VOLTage:LEVel {keysight_vset_ch4},(@4);:CURRent:LEVel {keysight_iset_ch4},(@4)"
)
